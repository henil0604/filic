...
var File = /** @class */ (function (_super) {
    ...
    function File(options) {
        return _super.call(this, __assign(__assign({}, options), { type: EntityTypes.FILE })) || this;
    }
    // Create Method
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        content = _a.sent();
                        Object.getPrototypeOf(content).toJSON = Utils.Try(function () { return JSON.parse(content); });
                        Object.getPrototypeOf(content).toBuffer = Utils.Try(function () { return Buffer.from(content); });
                        return [2 /*return*/, content];
                }
            });
        });
