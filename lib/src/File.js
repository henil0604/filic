...
class File extends Entity_1.default {
    constructor(options) {
        super(Object.assign(Object.assign({}, options), { type: Filic_1.EntityTypes.FILE }));
    }
    // Create Method
    create(options) {
    ...
    read(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Object.getPrototypeOf(content).toJSON = Utils_1.default.Try(() => JSON.parse(content));
            Object.getPrototypeOf(content).toBuffer = Utils_1.default.Try(() => Buffer.from(content));
            return content;
        });
    }
    readSync(options) {
