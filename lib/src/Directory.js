...
var Directory = /** @class */ (function (_super) {
    ...
    function Directory(options) {
        return _super.call(this, __assign(__assign({}, options), { type: EntityTypes.DIR })) || this;
    }
    // Create Method
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, rawList_1 = rawList; _i < rawList_1.length; _i++) {
                            ...
                            type = Entity.detectTypeWithPath(absolutePath);
                            caller = (type === EntityTypes.DIR) ? this.openDir : this.openFile;
    ...
    Directory.prototype.listSync = function () {
        ...
        for (var _i = 0, rawList_2 = rawList; _i < rawList_2.length; _i++) {
            ...
            var type = Entity.detectTypeWithPath(absolutePath);
            var caller = (type === EntityTypes.DIR) ? this.openDir : this.openFile;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        entity = list_1[_i];
                        if (!(entity.type === EntityTypes.DIR)) return [3 /*break*/, 4];
                        return [4 /*yield*/, entity.deleteSelf({ force: true, recursive: true })];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
                        if (!(entity.type === EntityTypes.FILE)) return [3 /*break*/, 6];
